document.addEventListener("DOMContentLoaded", function () {
  ...
  const messages = [
    ...
    "Oluwakemi.<br>This page exists for one reason:<br>You. And the joy of seeing you smile.",
    ...
    "Oluwakemi!<br>I may not be a magician...<br>But I made this just for you. Let the countdown begin.",
    ...
    "Oluwakemi,<br>This is for you.<br>A quiet countdown to something special.",
    ...
    "Oluwakemi.<br>I didn’t wrap this in paper, I built it in code.<br>A gift made with love... and a few lines of JavaScript."
  ];
